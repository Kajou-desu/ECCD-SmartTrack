...
export default function DeleteGoalModal({ goal, onCancel, onConfirm }) {
  return (
    <Modal
      onClose={onCancel}
    ...
    >
      <div className="flex items-start gap-4 p-5">
        ...
        <div className="min-w-0 flex-1">
          <h3 id="delete-goal-title" className="text-base font-bold text-slate-900">
            Delete Goal
          </h3>

          <p className="mt-1 text-sm leading-6 text-slate-600">
            Delete "{goal.title}"? Any progress recorded for it will be deleted too. This action
            cannot be undone.
          </p>
        </div>
