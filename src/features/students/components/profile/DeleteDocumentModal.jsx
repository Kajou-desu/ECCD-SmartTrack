...
export default function DeleteDocumentModal({ document, onCancel, onConfirm }) {
  return (
    <Modal
      onClose={onCancel}
    ...
    >
      <div className="flex items-start gap-4 p-5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm leading-6 text-slate-600">
            Remove "{document.name}"? This action cannot be undone.
          </p>
        </div>
      ...
      <div className="flex justify-end gap-2 border-t border-slate-200 p-4">
        ...
        <PrimaryButton label="Remove" onClick={onConfirm} />
      </div>
    </Modal>
  );
}
