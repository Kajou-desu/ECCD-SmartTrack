...
export const studentDataAll = {
    "POB2-2026-001": {
        ...
        medical: {
            ...
            dietary: ["Regular Diet — No dietary restrictions."],
    ...
    "POB2-2026-002": {
        ...
        medical: {
            allergies: ["Milk — Lactose intolerant. Provide dairy-free alternatives."],
            dietary: ["Dairy-Free Diet — Requires dairy-free milk and products."],
    ...
    "POB2-2026-004": {
        ...
        medical: {
            allergies: ["Shellfish — Severe allergy. Do not serve any shellfish products."],
            dietary: ["Shellfish-Free Diet — Avoid all seafood containing shellfish."],
    ...
    "POB2-2026-005": {
        ...
        medical: {
            allergies: ["None — No known allergies."],
            dietary: ["Vegetarian Diet — Prefers plant-based meals. No meat products."],
    ...
    "POB2-2026-006": {
        ...
        medical: {
            allergies: ["Eggs — Mild allergy. Causes mild rash. Avoid eggs and egg-based products."],
            dietary: ["Egg-Free Diet — No eggs or egg-containing foods."],
    ...
    "POB2-2026-009": {
        ...
        medical: {
            allergies: ["Peanuts, Tree Nuts — Severe nut allergy. EpiPen located in classroom locker #05."],
            dietary: ["Nut-Free Diet — Strict avoidance of all nut products."],
